...
export class ListComponent<T> implements OnInit {
  ...
  @Input() public readonly sortKey: string = 'name'; // 'name', 'title'... search text param key
  ...
  constructor(
    ...
    private readonly  produitServcie : ProductServiceHttp
  ) {
